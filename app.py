...
load_dotenv()  # Isso será ignorado no Render,
# que usa variáveis de ambiente reais
...
def verify_config():
    ...
    if (
        ...
        or app.config['SECRET_KEY'] == 'sua-chave-secreta'
    ):
        raise ValueError(
            "SECRET_KEY não configurada corretamente. Defina no Render.com"
        )
...
if __name__ == '__main__':
    ...
    print(
        f"🔑 SECRET_KEY configurada: "
        f"{'Sim' if app.config['SECRET_KEY'] else 'Não'}"
    )
